...
| `--timeout SECONDS` | `CLAUDE_BRIDGE_TIMEOUT` | hard cap: kill a Claude run (and everything it spawned) after this long, busy or not (default 1800, Hermes' own `gateway_timeout`; 0 = none) |
